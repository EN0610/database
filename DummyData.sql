...
VALUES
  ...
  (2, 1, 'Charlotte Jarvis', 'harryronchetti@gmail.com', '1986-05-05', 'Sivraj1', 'Life in reverse', 1,
      'charlotte-jarvis.jpg', 'Nerd Finder', 'Webmaster', 'Technology'),
  /* CLIENTS */
  (3, 3, 'Janet Anderson', 'dale.clement@northumbria.ac.uk', '1982-07-01', 'Redvelvet1', 'Favourite cupcake', 0,
      'janet-anderson.jpg', 'Cupcake Love', 'Managing Director', 'Hospitality'),
  (4, 3, 'Debbie Michaels', 'dale.clement@northumbria.ac.uk', '1971-06-21', 'Bewiser1', 'Personal goal', 1,
      'debbie-michaels.jpg', 'Pwizer', 'Senior Partner', 'Pharmaceuticals'),
  (5, 3, 'Paul Brown', 'dale.clement@northumbria.ac.uk', '1986-06-21', 'Clean4lyf', 'My aim', 0, 'paul-brown.jpg',
      'Super Soaps', 'Founder', 'Cosmetics'),
  (6, 3, 'Angela McCarthy', 'dale.clement@northumbria.ac.uk', '1991-01-08', 'Wincase5', 'What I do', 1,
      'angela-mccarthy.jpg', 'Pearson Spectre', 'Associate', 'Law');
...
VALUES
  /* NERDS */
  (7, 2, 'Pedro Dacantus', 'jack.breakell@northumbria.ac.uk', '1997-09-15', 'code15life', 'The truth', 0,
      'pedro-dacantus.jpg', 2, '20.00', 'pedro-dacantus-cv.pdf', 'pedro-dacantus/pedro-1.png',
   'pedro-dacantus/pedro-2.png', 'pedro-dacantus/pedro-3.png'),
  (8, 2, 'Tyler Eaton', 'jack.breakell@northumbria.ac.uk', '1988-10-04', 'Codem4ster', 'My alias', 1, 'tyler-eaton.jpg',
      10, '28.00', 'tyler-eaton-cv.pdf', 'tyler-eaton/tyler-1.png', 'tyler-eaton/tyler-2.png',
   'tyler-eaton/tyler-3.png'),
  (9, 2, 'Ben Giroux', 'jack.breakell@northumbria.ac.uk', '1979-08-24', 'Devt1ngs', 'My passion', 0, 'ben-giroux.jpg',
      18, '24.00', 'ben-giroux-cv.pdf', 'ben-giroux/ben-1.png', 'ben-giroux/ben-2.png', 'ben-giroux/ben-3.png'),
  (10, 2, 'Hanson Buork', 'jack.breakell@northumbria.ac.uk', '1991-11-29', 'Sk8rboy', 'Favourite activity', 1,
       'hanson-buork.jpg', 5, '32.00', 'hanson-buork-cv.pdf', 'hanson-buork/hanson-1.png', 'hanson-buork/hanson-2.png',
   'hanson-buork/hanson-3.png'),
  (11, 2, 'Penelope Holden', 'jack.breakell@northumbria.ac.uk', '1985-11-29', 'Edsheer4n', 'Favourite music artist', 1,
       'penelope-holden.jpg', 9, '22.00', 'penelope-holden-cv.pdf', 'penelope-holden/penelope-1.png',
   'penelope-holden/penelope-2.png', 'penelope-holden/penelope-3.png'),
  (12, 2, 'Alice Murphy', 'jack.breakell@northumbria.ac.uk', '1994-11-29', 'Bubble5', 'Floaty water things', 1,
       'alice-murphy.jpg', 4, '22.00', 'alice-murphy-cv.pdf', 'alice-murphy/alice-1.png', 'alice-murphy/alice-2.png',
   'alice-murphy/alice-3.png');
...
VALUES
  (1, 3, 3, 'Can I use Nerd Finder for re-designing my website?', '2017-01-18 09:04:19'),
  (2, 4, 1, 'Hire nerds with more experience, Tyler transformed by business!', '2017-02-03 18:10:46'),
  (3, 7, 4, 'My client hasn&#39;t paid me, what should I do?', '2017-01-26 17:09:01'),
  (4, 7, 2, 'Is being a full-time freelancer on Nerd Finder a good full time job?', '2017-01-27 22:56:08'),
  (5, 10, 1, 'Get Nerd Finder premium, it&#39;s amazing!', '2017-01-29 01:29:21'),
  (6, 11, 3, 'Are there any new features of Nerd Finder in development?', '2017-02-06 09:13:24'),
  (7, 11, 3, 'I work nights, are there any clients who have a similar schedule?', '2017-01-01 03:16:52'),
  (8, 12, 1, 'Include portfolio images that are the kind of work you&#39;d like to do!', '2017-02-07 11:34:30');

INSERT INTO nf_comments (commentid, postid, userid, commentcontent, posted)
VALUES
  (1, 1, 1, 'Hi Janet, you can use Nerd Finder for any development work related to websites, mobile apps, tablet apps and software. This means you can contact Nerds about creating new websites, fixing old ones and adjusting small tweaks! For more information about the service we provide check out our &#39;How it works&#29; page', '2017-01-18 09:51:21')
  (2, 6, 9, 'Bet they aren&#39;t even updating anything, their customer service is crap!', '2017-02-06 09:15:24')
  (3, 7, 8, 'Pedro, the world is your oyster! If you are passionate about working as a freelancer full-time I recommend looking at articles in .net magazine for inspiration and advice on how to price work effectively per hour.', '2017-01-28 09:31:13');

INSERT INTO nf_messages (messageid, senderid, recieverid, messagecontent, messagesent)
VALUES
  (1, 6, 7, 'Hi Pedro, I see you&#39;re a specialist in website development. Would you be interested in working on the Pearson Spectre site?', '2017-01-10 10:51:21'),
  (2, 7, 6, 'Hi Angela, yes I am very interested! Do you have an style guides or regulations I would need to abide to?', '2017-01-10 10:52:35'),
  (3, 6, 7, 'Yes, we do actually, I&#39;ll send them over in a minute', '2017-01-10 10:53:26');

INSERT INTO nf_techissues (issueid, reporterid, issuedescription, issuesent)
VALUES
  (1, 1, 'Project inspiration image save location incorrect', '2017-01-18 11:34:12');